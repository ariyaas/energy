...
export default function PremiumComparison() {
    ...
    <section className="py-4 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          ...
          {/* OTHERS */}
          <div className="order-1 md:order-1 rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 
 ...
 <div className="order-2 md:order-2  rounded-2xl md:rounded-3xl p-5 sm:p-6 md:p-8 
